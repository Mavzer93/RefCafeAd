...
namespace MigrationsSqlServer.Migrations
{
    ...
    [Migration("20230709120352_Kickoff")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RefCafeAData.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RefCafeAData.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RefCafeAData.Rayon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RefCafeAData.ShoppingCartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CategoryProduct", b =>
                {
                    b.HasOne("RefCafeAData.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RefCafeAData.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("RefCafeAData.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("RefCafeAData.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RefCafeAData.Address", b =>
                {
                    b.HasOne("RefCafeAData.City", "City")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("RefCafeAData.Category", b =>
                {
                    b.HasOne("RefCafeAData.Rayon", "Rayon")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("RefCafeAData.City", b =>
                {
                    b.HasOne("RefCafeAData.Province", "Province")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("RefCafeAData.Comment", b =>
                {
                    b.HasOne("RefCafeAData.ApplicationUser", "ApplicationUser")
                        .WithMany("Comments")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RefCafeAData.Product", "Product")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("RefCafeAData.Order", b =>
                {
                    ...
                    b.HasOne("RefCafeAData.Address", "DeliveryAddress")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("RefCafeAData.OrderItem", b =>
                {
                    b.HasOne("RefCafeAData.Order", "Order")
                        .WithMany("OrderItems")
